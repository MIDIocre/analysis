...
print 'full\t'+'\t'.join(map(str,(sumdists-sumdists.mean())/sumdists.std()))+'\t'+'\t'.join(map(str,(sumdistsb-sumdistsb.mean())/sumdistsb.std()))+'\t'+'\t'.join(map(str,(sumnotes-sumnotes.mean())/sumnotes.std()))+'\t'+'\t'.join(map(str,([np.median(durations),np.std(durations)])))+'\t'+'\t'.join(map(str,([np.median(allnotes),np.std(allnotes)])))
